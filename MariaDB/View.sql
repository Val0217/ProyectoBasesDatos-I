...
SELECT
    ...
    (
        SELECT CAST(MIN(ph.Phone) AS CHAR)
        FROM Phone ph
...
SELECT
    ...
    petState.Id AS IdState,
    petState.Name AS PetState,
    petType.Name AS PetType,
    breed.Name AS Breed,
    ...
    CASE
        ...
        ELSE CONCAT(vet.FirstName, ' ', vet.LastName)
...
LEFT JOIN PetState petState
    ON p.IdState = petState.Id
...
LEFT JOIN PetState petState ON p.IdState = petState.Id
